...
enum
{
    ...
    //CAN_FUNC_ID_RT_STATUS     = 0x4,  //联动控制信息(实时指令)(每个模块状态改变后主动发出)(起停,堵包,报警,暂停)
...
extern u16 slave_cnt ;

extern u16 pre_slave_count[];
extern u16 cur_slave_count[];
extern u16 slave_err_cnt[];
extern u16 upload_can_err_buff[];
